...
the `lost_track_buffer` change and nothing else.
    ...
    /root/vast/eric/luc3d-bench/eks_env/bin/python figs/fig6_bytetrack_max2.py \
        --stage track --workers 10
    /root/vast/eric/luc3d-bench/liezl_env/bin/python figs/fig6_bytetrack_max2.py \
...
def main():
    ...
    (OUT / a.out).write_text(json.dumps({
        "generated_by": "figs/fig6_bytetrack_max2.py",
