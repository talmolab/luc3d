...
slot-coherence statistic alongside the scores so the reader can see the premise holds.
    ...
    $PY figs/fig7_sleap_retracked.py --dry-run
    $PY figs/fig7_sleap_retracked.py --sessions 20250829_124351   # one session
    $PY figs/fig7_sleap_retracked.py                              # all 50
...
def main():
    ...
    (OUT / "fig7_sleap_retracked.json").write_text(json.dumps({
        "generated_by": "figs/fig7_sleap_retracked.py",
