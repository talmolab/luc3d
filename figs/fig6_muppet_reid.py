...
the faithful port's shipped numbers.
    ...
    halves fixed (`fig6_sleap_max2_retrack.py`, `fig6_bytetrack_max2.py`). Those two
...
precisiontrack_env only, and `scripts/evaluate.py` imports it at module scope.
    ...
    /root/vast/eric/luc3d-bench/liezl_env/bin/python figs/fig6_muppet_reid.py --gate
    /root/vast/eric/luc3d-bench/liezl_env/bin/python figs/fig6_muppet_reid.py \
...
def main():
    ...
    dep = {
        "generated_by": "figs/fig6_muppet_reid.py",
