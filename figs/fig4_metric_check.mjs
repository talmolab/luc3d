 ...
 *
 * THE HAZARD. The anipose arm (figs/fig4_anipose.py) scores reprojection error with
 ...
 * error per camera. Checked by `fig4_anipose.py --verify-metric`.
 *
 * Usage: node figs/fig4_metric_check.mjs --n 20000
 */
...
/** Verbatim `nativeError` from fig4_measure.mjs -- do not "improve" it here. */
