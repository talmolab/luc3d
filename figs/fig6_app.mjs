 ...
 *
 * Runs on a SLAP-2M session built by figs/fig6_session.py. Two states:
 *
 ...
 *
 * Usage:
 *   SESSION_REL=figs/session-slap-<id> node figs/fig6_app.mjs
 *   SESSION_REL=... VIDEOS=0 node figs/fig6_app.mjs      # rig panel only
 */
import {
