...
C) The same frame triangulated. Left, cam 0 mid with identity overlays; middle, the
...
D) Capability comparison against 7 multi-animal or multi-camera pose tools, read from
