...
per-session p25 to p75 for the DLT. DLT 4.32, 3.65 and 3.34 px and refinement 4.43,
3.53 and 3.15 px at 2, 3 and 4 cameras. n = 31.9, 21.3 and 5.3 million held-out
measurements.
...
(n = 1,167,554, 3,019,181 and 66,901). Boxes, p25 to p75; whiskers, p5 to p95; box
...
whisker spans session sizes, since the cost per keypoint of Anipose optim falls as
fixed costs amortise.
