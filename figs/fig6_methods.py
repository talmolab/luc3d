...
from `fig6_param_sweeps.py` is the driver: `figs/fig6-bench/fig6_bench.mjs`, which
serves `figs/fig6-bench/xv_experimental.js` in place of pose/cross-view-tracker.js via
...
xv_experimental.js, which is the part worth reading before adding another method.
    ...
    $PY figs/fig6_methods.py --verify              # prove the fork == shipped tracker
    $PY figs/fig6_methods.py                       # run every config
    $PY figs/fig6_methods.py --configs bundle,bundle_reid4
    $PY figs/fig6_methods.py --recheck             # do cached cells still reproduce?
    $PY figs/fig6_methods.py --reaggregate         # redo vs_shipped, no re-scoring
    $PY figs/fig6_methods.py --per-session         # merge per-session detail
...
def verify():
    ...
    Tracks all 8 FULL sessions through fig6_bench.mjs + xv_experimental.js with an
    ...
    dest.write_text(json.dumps({
        "generated_by": "figs/fig6_methods.py --verify",
        "claim": "figs/fig6-bench/xv_experimental.js with an EMPTY method block "
...
def recheck(names, session=None, workers=None):
    ...
    dest.write_text(json.dumps({
        "generated_by": "figs/fig6_methods.py --recheck",
...
def main(names):
    ...
    out = {
        "generated_by": "figs/fig6_methods.py",
        ...
        "caveats": [
            ...
            "frame, no window -- exactly as fig3_sweep.py and fig6_param_sweeps.py "
            ...
            "No app source is modified. figs/fig6-bench/hooks6.mjs serves "
            "figs/fig6-bench/xv_experimental.js in place of pose/cross-view-tracker.js "
