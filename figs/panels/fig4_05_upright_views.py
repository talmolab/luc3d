...
a plain translucent box because this dataset has no cage geometry. Regenerate with:
    ...
    cd figs/blender-images && ./bpyenv/bin/python fig4a_scene.py \
        --azim 255 --elev 22 --ortho 0.335 --box 230 230 140 \
        --samples 200 --res 1900 1900 --out renders/fig4a_upright.png
...
Source: figs/out/fig5_views.json (figs/fig4_views.py, which needs the bench env),
plus blender-images/renders/fig4a_upright.png (command above).
...
RENDER = FIGS / "blender-images" / "renders" / "fig4a_upright.png"
BOX_MM = (230, 230, 140)             # the render's volume; keep in sync with the
                                     # fig4a_scene.py command in the docstring
