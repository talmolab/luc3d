...
Writes to figures/fig3/_association_top.pdf -- an INTERMEDIATE, not a real
...
figures/fig3/fig3a_association.pdf with the merged a+b composite -- run this
script BEFORE fig3_sync.py.
...
# provenance marker for make_docs.panel_script: save(fig, 3, "a", "association")
