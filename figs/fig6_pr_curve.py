...
thresholds cost N assignment solves, not N full re-scores.
    ...
    $PY figs/fig6_pr_curve.py                       # all 50 sessions, default configs
    $PY figs/fig6_pr_curve.py --max-frames 3000 --sessions 20250827_141755   # smoke
...
def main():
    ...
    dest.write_text(json.dumps({
        "generated_by": "figs/fig6_pr_curve.py",
