...
sheet) so switches can be read per stratum.
    ...
    $PY figs/fig5_slap2m.py --dry-run
    $PY figs/fig5_slap2m.py                       # shipped + the Fig 8 winner
    $PY figs/fig5_slap2m.py --configs shipped
...
def main():
    ...
    dest.write_text(json.dumps({
        "generated_by": f"figs/fig5_slap2m.py --pool {a.pool}",
