 ...
 *
 * Usage:
 *   /root/.../lp3d_env/bin/python figs/fig2_solvers_export.py     # -> figs/out/fig4_input.json
 *   node figs/fig2_solvers_measure.mjs                            # -> figs/out/fig4.json
 */
...
// Our own hooks, not the branch's: see figs/fig2_solvers_hooks.mjs for why.
const HOOKS = path.join(HERE, 'fig2_solvers_hooks.mjs');
...
if (!fs.existsSync(inPath)) throw new Error(`run figs/fig2_solvers_export.py first (${inPath})`);
